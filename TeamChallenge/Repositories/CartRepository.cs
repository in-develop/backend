...
{
    public class CartRepository(CosmeticStoreDbContext context, ILogger<IRepository<CartEntity>> logger)
        : BaseRepository<CartEntity>(context, logger), ICartRepository
    {
